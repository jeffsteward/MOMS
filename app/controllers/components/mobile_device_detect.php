<?php
class MobileDeviceDetectComponent extends Object
{
...
*/
	...
	function detect()
	{
		// Redirect everything but the iPad
		if($this->mobile_device_detect(true,false,true,true,true,true,true,false,false) == true)
		{
			$this->isMobile = true;
